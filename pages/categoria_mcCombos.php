...
<body>
  ...
  <section style="padding: 2rem 0;">
    <div class="container" style="font-family: 'Hind Vadodara', sans-serif;">
        <h1 style="font-size: 2.5rem; font-weight: bolder;">Menú > McCombos</h1>
        ...
        $query_bd = "SELECT * FROM menu_mcdelivery WHERE categoria_menu = 'McCOMBO'"; 
                ...
                <div class="col-sm-12 col-md-6 col-lg-3">
                    <div class="card border-warning mb-3" style="max-width: 19rem; height: 32rem; margin-top: 1rem;">
                        <div class="text-center">
                            ...
                            <img class="card-img-top" src="' . $unaFila["imagen_menu"] . '" alt="imagen del producto" width="50">
                            <div class="card-body">
