...
$query = "SELECT * FROM menu_mcdelivery";
...
<div class="container">
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-0 border-bottom">
      ...
      <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
        ...
        <li class="link_menu"><a href="#" class="nav-link px-2 link-dark">Productos</a></li>
  ...
  <section style="padding: 2rem 0;">
    <div class="container" style="font-family: 'Hind Vadodara', sans-serif;">
        <h1 style="font-size: 2.5rem; font-weight: bolder;">Productos</h1>
        <div class="row">
            <?php
            if ($resultado) {
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-3">
                        <div class="card border-warning mb-3" style="max-width: 19rem; height: 32rem; margin-top: 1rem;">
                            <div class="text-center">
                                <div class="card-header">' . $producto["categoria_menu"] . '</div>
                                <img class="card-img-top" src="' . $producto["imagen_menu"] . '" alt="imagen del producto">
                                <div class="card-body">
                                    <h5 class="card-title" style="font-size: 21px; font-weight:bold">' . $producto["producto_menu"] . '</h5>
                                    <br>
                                    <h6 style="font-size: 22px; font-weight:bold; color: grey">$ ' . number_format($producto["precio_menu"], 2, ',', '.') . '</h6>
                                    <br>
                                    <!-- botón que me lleva a la página del producto -->
                                    <a href="ver_producto.php?id_menu=' . $producto["id_menu"] . '" class="btn btn-warning">Ver producto</a>
                                    <br>
                                </div>
                            </div>
                        </div>
